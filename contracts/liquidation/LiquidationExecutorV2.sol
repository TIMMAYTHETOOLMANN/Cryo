...
// ============================================================================
//  LiquidationExecutorV2 - Enhanced with stats, multi-asset sweep, batch ops
// ============================================================================
interface IERC20 {
...
contract LiquidationExecutorV2 {
    ...
    bool    public surplusUtilizationEnabled = true;
    ...
    function executeLiquidation(
        ...
        require(supportedDebtAssets[debtAsset], "Unsupported");
    ...
    function executeOperation(
        ...
        // Profit = collateral minus nothing if cross-asset, tracked as collateral units
        uint256 profit = collateralSeized;
        // Sweep to treasury
        ...
        totalLiquidations++;
        totalProfit += profit;
        emit LiquidationExecuted(user, asset, collateralAsset, amount, collateralSeized, profit);
        return true;
    }
    ...
    function setSurplusUtilization(bool _enabled) external onlyOwner {
        surplusUtilizationEnabled = _enabled;
    }
    function withdrawProfit(address token, uint256 amount, address to) external onlyOwner {
        IERC20(token).transfer(to, amount);
    }
    function getStats() external view returns (uint256, uint256) {
        return (totalLiquidations, totalProfit);
    }
